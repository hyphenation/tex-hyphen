...
In 2008 the generating script has been rewritten into ruby and
adapted for native UTF-8 TeX engines, but the generated patterns
should remain the same, only ñ has been added by default.
...
For more information about the new UTF-8 hyphenation patterns see
